package com.snapmaker.fabscreen.modules.guide10wlaser.getstarted;
...
public class Guide10wLaserGetStartedFragment extends BaseFragment {
    ...
    Button mBtnBack;
    @BindView(R.id.btn_guide_10w_laser_get_started_next)
    Button mBtnStart;

    @BindView(R.id.cb_guide_10w_laser_get_started_accept)
    CheckBox mCbAccept;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!getModel().getPreferences().getMachineSetup10WLaser()) {
    ...
    @OnClick(R.id.btn_guide_10w_laser_get_started_next)
    void onClickNext() {
