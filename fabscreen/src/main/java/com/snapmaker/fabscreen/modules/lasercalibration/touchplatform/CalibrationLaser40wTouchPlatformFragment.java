...
public class CalibrationLaser40wTouchPlatformFragment extends BaseFragment {
    ...
    public static CalibrationLaser40wTouchPlatformFragment newInstance() {
        return new CalibrationLaser40wTouchPlatformFragment();
    }
    ...
    void onCompleteClicked() {
        ...
        ((LaserCalibrationActivity) requireActivity()).start40wPlatformHeightPullInFocusLever();
    }
}
