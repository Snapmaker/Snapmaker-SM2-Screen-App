...
public class PreviewLaser2wPrepareSafetyGogglesFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mTvMessage.setText(R.string.laser_2w_safety_goggles_message);
        ...
        getModel().getPrintController().getHeaderSecurityStatus()
                ...
                .subscribe(headerSecurity -> {
                    if (headerSecurity.status == 0) {
                        if (autoMode) {
                            activity.gotoLaser2wPrepareSetOriginFragment(autoMode);
                        } else {
                            activity.gotoLaser2wTouchPlatformFragment();
                        }
                    } else {
