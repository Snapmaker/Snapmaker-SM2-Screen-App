...
public class Guide20wLaserPullOutFocusLeverFragment extends BaseFragment {
    public static Guide20wLaserPullOutFocusLeverFragment newInstance() {
        return new Guide20wLaserPullOutFocusLeverFragment();
    }
        ...
        getModel().getPrintController().getHeaderSecurityStatus()
                ...
                .subscribe(headerSecurity -> {
                    if (headerSecurity.status == 0) {
                        ...
                        ((Guide20wLaserActivity) getActivity()).startTouchPlatformFragment();
                    }
                });
    }
}
