...
public class DualExtruderXYCalibrationStartFragment extends BaseFragment {

    private DualExtruderXYCalibrationPrintViewModel mViewModel;

    public static Fragment newInstance() {
        return new DualExtruderXYCalibrationStartFragment();
    }
        ...
        mViewModel.parseFile()
                ...
                .subscribe(progress -> {
                    ...
                    if (progress == 100) {
                        ...
                        ((DualExtruderXYCalibrationActivity) requireActivity()).goXYCalibrationPrint();
                    }
                }, LogHelper::log);
    }
