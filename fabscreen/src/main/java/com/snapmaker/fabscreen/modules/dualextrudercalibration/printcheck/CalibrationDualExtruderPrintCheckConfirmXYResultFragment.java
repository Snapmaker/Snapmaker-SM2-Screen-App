...
public class CalibrationDualExtruderPrintCheckConfirmXYResultFragment extends BaseFragment {
    public static CalibrationDualExtruderPrintCheckConfirmXYResultFragment newInstance() {
        return new CalibrationDualExtruderPrintCheckConfirmXYResultFragment();
    }
    ...
    void onClickXYNext() {
        ((CalibrationDualExtruderPrintCheckActivity) requireActivity()).startPrintCheckConfirmComplete();
    }
}
