...
public class PreviewLaser2wTouchPlatformFragment extends BaseFragment {
    ...
    public static PreviewLaser2wTouchPlatformFragment newInstance() {
        return new PreviewLaser2wTouchPlatformFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMaskTextDesc.setText(R.string.preview_laser_2w_prepare_low_lever_and_touch_platform_desc);
        mIvPlatformHeight.setImageResource(R.drawable.pic_laser_2w_3axis_prepare_platform_height_360x320);
