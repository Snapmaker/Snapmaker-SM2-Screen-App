...
public class PreviewLaser2wPrepareModeFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        mTvModeInputMaterialThicknessDesc.setText(R.string.preview_2w_input_material_thickness_desc);
        mTvModeFocusLeverAssistedDesc.setText(R.string.preview_2w_focus_lever_assisted_desc);
        mBtnInputMaterialThickness.setText(R.string.preview_2w_input_material_thickness);
        mBtnFocusLeverAssisted.setText(R.string.preview_2w_focus_lever_assisted);
    }
    ...
    void onClickAutoMode() {
        ...
        if (activity != null) {
            activity.gotoLaser2wPrepareMaterialFragment();
        }
    }
    ...
    void onClickManualMode() {
        ...
        activity.gotoLaser2wPrepareSafetyGogglesFragment(false);
    }
}
