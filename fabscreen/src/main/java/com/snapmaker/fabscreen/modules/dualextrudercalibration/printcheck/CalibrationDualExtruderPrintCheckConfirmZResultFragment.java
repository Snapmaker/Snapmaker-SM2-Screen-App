...
import com.snapmaker.fabscreen.modules.guidedualextruder.printcheck.GuideDualExtruderPrintCheckPrintViewModel;
...
public class CalibrationDualExtruderPrintCheckConfirmZResultFragment extends BaseFragment {
    public static CalibrationDualExtruderPrintCheckConfirmZResultFragment newInstance() {
        return new CalibrationDualExtruderPrintCheckConfirmZResultFragment();
    }
    ...
    void onClickZNext() {
        ((CalibrationDualExtruderPrintCheckActivity) requireActivity()).startPrintCheckConfirmXY();
    }
}
