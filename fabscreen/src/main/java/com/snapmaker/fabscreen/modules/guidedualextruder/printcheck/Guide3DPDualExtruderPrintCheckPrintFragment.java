...
public class Guide3DPDualExtruderPrintCheckPrintFragment extends BaseFragment {
    // progress
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_guide_3dp_dual_extruder_print_check_print;
    }
...
//        int elapsed = getModel().getPrintController().getTickCounter().getCount();
    ...
    private void handleCalibrationPrintFinish() {
        ((Guide3DPDualExtruderPrintCheckActivity) requireActivity()).lockDrawer();
        ((Guide3DPDualExtruderPrintCheckActivity) requireActivity()).startPrintCheckPrintComplete();
    }
