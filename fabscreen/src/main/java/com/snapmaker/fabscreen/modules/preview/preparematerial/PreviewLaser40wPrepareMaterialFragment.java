...
public class PreviewLaser40wPrepareMaterialFragment extends BaseFragment {
    public static PreviewLaser40wPrepareMaterialFragment newInstance() {
        return new PreviewLaser40wPrepareMaterialFragment();
    }
    ...
    void onClickNext() {
        ...
        if (getActivity()!= null) {
            ((PreviewActivity) getActivity()).gotoLaser40wPrepareSafetyGogglesFragment(true);
        }
    }
}
