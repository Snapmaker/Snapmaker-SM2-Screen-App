...
public class PreviewLaser40wRotaryMeasureHeightFragment extends BaseFragment {
    public static PreviewLaser40wRotaryMeasureHeightFragment newInstance() {
        return new PreviewLaser40wRotaryMeasureHeightFragment();
    }
    ...
    private void initView() {
        ...
        mIvPlatformHeight.setImageResource(R.drawable.pic_laser_40w_4axis_prepare_platform_height_360x320);
