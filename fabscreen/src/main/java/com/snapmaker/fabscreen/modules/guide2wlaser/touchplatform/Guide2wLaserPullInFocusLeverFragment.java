...
public class Guide2wLaserPullInFocusLeverFragment extends BaseFragment {
    public static Guide2wLaserPullInFocusLeverFragment newInstance() {
        return new Guide2wLaserPullInFocusLeverFragment();
    }
    ...
    void onClickNext() {
        ...
        ((Guide2wLaserActivity) getActivity()).startCompleteFragment();
    }
}
