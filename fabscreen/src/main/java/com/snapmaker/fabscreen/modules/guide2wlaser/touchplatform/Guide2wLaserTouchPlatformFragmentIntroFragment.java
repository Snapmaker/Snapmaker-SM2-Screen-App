...
public class Guide2wLaserTouchPlatformFragmentIntroFragment extends BaseFragment {
    public static Guide2wLaserTouchPlatformFragmentIntroFragment newInstance() {
        return new Guide2wLaserTouchPlatformFragmentIntroFragment();
    }
    ...
    private void initView() {
        mIvCover.setImageResource(R.drawable.pic_laser_2w_3axis_prepare_platform_height_intro_360x320);
        ...
        getModel().getPrintController().getHeaderSecurityStatus()
                ...
                .subscribe(headerSecurity -> {
                    if (headerSecurity.status == 0) {
                        ...
                        ((Guide2wLaserActivity) getActivity()).startPullOutFocusLeverFragment();
                    }
                });
    }
}
