...
public class Guide3DPDualExtruderPrintCheckPrintDrawerFragment extends BaseFragment implements Guide3DPDualExtruderPrintCheckActivity.OnDrawerOpenedListener {
    private static final String TAG = "Guide3DPDualExtruderPrintCheckPrintDrawer";
    ...
    private void initView() {
        ...
        if (getActivity() != null) {
            ((Guide3DPDualExtruderPrintCheckActivity) getActivity()).setOnDrawerOpenedListener(this);
        }
    }
    ...
    @Override
    protected void back() {
        Guide3DPDualExtruderPrintCheckActivity activity = (Guide3DPDualExtruderPrintCheckActivity) getContext();
        if (activity != null) {
