...
public class CNC4AxisSetOriginPagerPresenter implements DefaultLifecycleObserver {
    ...
    public CNC4AxisSetOriginPagerPresenter(Context context, Model model) {
    ...
    private void onClickGotoOrigin(View v) {
        ...
        if (currentZ > 0) {
            ...
            getModel().getSlaveComputer().sendGcode("G0 X0 Y0 F3000")
                    .flatMap(res -> getModel().getSlaveComputer().sendGcode("G0 B0 F3000"))
            ...
            getModel().getSlaveComputer().sendGcode("G0 Z0 F1800")
