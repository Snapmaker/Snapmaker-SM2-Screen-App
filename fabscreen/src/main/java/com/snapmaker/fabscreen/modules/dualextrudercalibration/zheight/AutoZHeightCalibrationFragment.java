...
import static com.snapmaker.fabscreen.modules.dualextrudercalibration.zheight.AutoZHeightCalibrationViewModel.Process.*;
...
public class AutoZHeightCalibrationFragment extends BaseFragment {

    private AutoZHeightCalibrationViewModel mViewModel;

    public static Fragment newInstance() {
        return new AutoZHeightCalibrationFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mViewModel = getFragmentScopeViewModel(AutoZHeightCalibrationViewModel.class);
        initView();
    }
    ...
    private void refreshUI(AutoZHeightCalibrationViewModel.Process process) {
        if (mBtnTopBarBack == null) return;
        switch (process) {
            case CALIBRATING:
