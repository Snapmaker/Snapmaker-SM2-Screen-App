...
public class Guide3DPDualExtruderXYCalibrationPrintFragment extends BaseFragment {
    // progress
...
//        int elapsed = getModel().getPrintController().getTickCounter().getCount();
    ...
    private void handleCalibrationPrintFinish() {
        ((GuideDualExtruderXYCalibrationActivity) requireActivity()).lockDrawer();
        ((GuideDualExtruderXYCalibrationActivity) requireActivity()).goXYCalibrationPrintComplete();
    }
