...
public class XYCalibrationPrintDrawer3DPDualExtruderFragment extends BaseFragment implements DualExtruderXYCalibrationActivity.OnDrawerOpenedListener {
    ...
    private void initView() {
        ...
        if (getActivity() != null) {
            ((DualExtruderXYCalibrationActivity) getActivity()).setOnDrawerOpenedListener(this);
        }
    }
    ...
    @Override
    protected void back() {
        DualExtruderXYCalibrationActivity activity = (DualExtruderXYCalibrationActivity) getContext();
        if (activity != null) {
