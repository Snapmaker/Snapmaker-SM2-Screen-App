...
public class CalibrationDualExtruderPrintCheckPrintDrawerFragment extends BaseFragment implements CalibrationDualExtruderPrintCheckActivity.OnDrawerOpenedListener {
    ...
    private void initView() {
        ...
        if (getActivity() != null) {
            ((CalibrationDualExtruderPrintCheckActivity) getActivity()).setOnDrawerOpenedListener(this);
        }
    }
    ...
    @Override
    protected void back() {
        CalibrationDualExtruderPrintCheckActivity activity = (CalibrationDualExtruderPrintCheckActivity) getContext();
        if (activity != null) {
