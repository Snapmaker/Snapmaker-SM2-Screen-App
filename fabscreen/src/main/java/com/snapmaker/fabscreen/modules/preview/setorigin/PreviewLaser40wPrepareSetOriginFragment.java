...
public class PreviewLaser40wPrepareSetOriginFragment extends BaseFragment {
    ...
    void onClickStart() {
        ((PreviewActivity) requireActivity()).gotoLaser40wPreparePrintSafetyNoticeFragment(mViewModel.getLaserIndicatorMode());
    }
