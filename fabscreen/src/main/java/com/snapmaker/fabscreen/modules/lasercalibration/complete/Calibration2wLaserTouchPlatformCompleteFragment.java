...
public class Calibration2wLaserTouchPlatformCompleteFragment extends BaseFragment {
    public static Calibration2wLaserTouchPlatformCompleteFragment newInstance() {
        return new Calibration2wLaserTouchPlatformCompleteFragment();
    }
