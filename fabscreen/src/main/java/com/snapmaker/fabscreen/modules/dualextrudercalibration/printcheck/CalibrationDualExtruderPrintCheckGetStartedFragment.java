...
public class CalibrationDualExtruderPrintCheckGetStartedFragment extends BaseFragment {
    public static CalibrationDualExtruderPrintCheckGetStartedFragment newInstance() {
        return new CalibrationDualExtruderPrintCheckGetStartedFragment();
    }
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_calibration_dual_extruder_print_check_get_started;
    }
        ...
        mViewModel.parseFile()
                ...
                .subscribe(progress -> {
                    ...
                    if (progress == 100) {
                        ...
                        ((CalibrationDualExtruderPrintCheckActivity) requireActivity()).startPrintCheckPrint();
                    }
                }, LogHelper::log);
    }

    @OnClick(R.id.btn_calibration_dual_extruder_print_check_get_started)
    void onClickStart() {
// prepare file
    ...
    @OnClick(R.id.btn_calibration_dual_extruder_print_check_skip)
    void onClickSkip() {
        FabConfirm.create(requireContext())
                ...
                .setConfirm(R.string.all_skip, (dialog, which) -> {
                    dialog.dismiss();
                    ((CalibrationDualExtruderPrintCheckActivity) requireActivity()).finish();
                })
