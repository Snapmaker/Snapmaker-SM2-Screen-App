...
public class Guide2wLaserPullOutFocusLeverFragment extends BaseFragment {
    public static Guide2wLaserPullOutFocusLeverFragment newInstance() {
        return new Guide2wLaserPullOutFocusLeverFragment();
    }
        ...
        getModel().getPrintController().getHeaderSecurityStatus()
                ...
                .subscribe(headerSecurity -> {
                    if (headerSecurity.status == 0) {
                        ...
                        ((Guide2wLaserActivity) getActivity()).startTouchPlatformFragment();
                    }
                });
    }
}
