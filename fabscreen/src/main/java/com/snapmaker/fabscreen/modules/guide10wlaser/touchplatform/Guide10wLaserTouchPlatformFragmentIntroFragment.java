...
public class Guide10wLaserTouchPlatformFragmentIntroFragment extends BaseFragment {
    public static Guide10wLaserTouchPlatformFragmentIntroFragment newInstance() {
        return new Guide10wLaserTouchPlatformFragmentIntroFragment();
    }
    ...
    private void initView() {
        mIvCover.setImageResource(R.drawable.pic_laser_10w_settings_touch_platform_360x320);
