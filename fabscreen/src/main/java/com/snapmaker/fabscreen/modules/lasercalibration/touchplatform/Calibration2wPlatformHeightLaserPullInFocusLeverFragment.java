...
public class Calibration2wPlatformHeightLaserPullInFocusLeverFragment extends BaseFragment {
    public static Calibration2wPlatformHeightLaserPullInFocusLeverFragment newInstance() {
        return new Calibration2wPlatformHeightLaserPullInFocusLeverFragment();
    }
    ...
    void onClickNext() {
        ...
        ((LaserCalibrationActivity) requireActivity()).start2wPlatformHeightComplete();
