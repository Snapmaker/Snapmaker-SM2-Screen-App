...
public class Guide40wLaserPullInFocusLeverFragment extends BaseFragment {
    public static Guide40wLaserPullInFocusLeverFragment newInstance() {
        return new Guide40wLaserPullInFocusLeverFragment();
    }
    ...
    void onClickNext() {
        ...
        ((Guide40wLaserActivity) getActivity()).startCompleteFragment();
    }
}
