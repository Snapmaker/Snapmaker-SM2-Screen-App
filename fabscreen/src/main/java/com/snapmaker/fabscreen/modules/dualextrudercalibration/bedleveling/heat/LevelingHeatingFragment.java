...
import com.snapmaker.fabscreen.modules.dualextrudercalibration.bedleveling.heat.LevelingHeatingViewModel.BedTemperature;
...
public class LevelingHeatingFragment extends BaseFragment {
    public static Fragment newInstance() {
        return new LevelingHeatingFragment();
    }

    private LevelingHeatingViewModel mFragmentViewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mFragmentViewModel = getFragmentScopeViewModel(LevelingHeatingViewModel.class);
        initView();
    }

    private void initView() {
        setTitle(R.string.leveling_heat_bed_title);
        alertAndStartHeat();
    ...
    private void refreshTempUI(BedTemperature temperature) {
