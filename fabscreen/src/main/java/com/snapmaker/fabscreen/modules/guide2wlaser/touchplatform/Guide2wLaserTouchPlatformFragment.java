package com.snapmaker.fabscreen.modules.guide2wlaser.touchplatform;
...
public class Guide2wLaserTouchPlatformFragment extends BaseFragment {
    @BindView(R.id.top_bar_back)
    Button mBtnBack;
    @BindView(R.id.btn_laser_2w_touch_platform_complete)
    Button mBtnComplete;
    @BindView(R.id.xyz_panel_touch_platform)
    XYZControlPanel mControlPanel;
    @BindView(R.id.iv_laser_2w_touch_platform)
    ImageView mIvPlatformHeight;

    private TouchPlatformViewModel mViewModel;

    public static Guide2wLaserTouchPlatformFragment newInstance() {
        return new Guide2wLaserTouchPlatformFragment();
    }
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_laser_2w_touch_platform;
    }
    ...
    @OnClick(R.id.btn_laser_2w_touch_platform_complete)
    void onCompleteClicked() {
        mViewModel.savePlatformZOffset();

        ((Guide2wLaserActivity) requireActivity()).startPullInFocusLeverFragment();
    }
}
