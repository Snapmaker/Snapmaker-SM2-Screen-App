...
public class CalibrationDualExtruderPrintCheckPrintFragment extends BaseFragment {
    public static CalibrationDualExtruderPrintCheckPrintFragment newInstance() {
        return new CalibrationDualExtruderPrintCheckPrintFragment();
    }
    // progress
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_calibration_dual_extruder_print_check_print;
    }

    private void initView() {
        mTvFilename.setSelected(true);
        mTvFilename.setText(R.string.calibration_dual_extruder_print_check_print_model_name);
        ...
        mDetailPanelWidgetPresenter.setEstimatedTime(15 * 60);
    ...
    private void initPrintJob() {
        final IFile printFile = mViewModel.getPrintCheckPrintFile();
    ...
    private void startPrint() {
        ...
        printController.setFile(mViewModel.getPrintCheckPrintFile());
...
//        int elapsed = getModel().getPrintController().getTickCounter().getCount();
    ...
    private void handleCalibrationPrintFinish() {
        ((CalibrationDualExtruderPrintCheckActivity) requireActivity()).lockDrawer();
        ((CalibrationDualExtruderPrintCheckActivity) requireActivity()).startPrintCheckPrintComplete();
    }
