...
public class Calibration40wPlatformHeightLaserPullOutFocusLeverFragment extends BaseFragment {
    public static Calibration40wPlatformHeightLaserPullOutFocusLeverFragment newInstance() {
        return new Calibration40wPlatformHeightLaserPullOutFocusLeverFragment();
    }
        ...
        getModel().getPrintController().getHeaderSecurityStatus()
                ...
                .subscribe(headerSecurity -> {
                    if (headerSecurity.status == 0) {
                        ...
                        ((LaserCalibrationActivity) getActivity()).start40wPlatformHeightCalibration();
                    }
                });
    }
}
