...
public class Guide20wLaserTouchPlatformFragment extends BaseFragment {
    @BindView(R.id.top_bar_back)
    Button mBtnBack;
    @BindView(R.id.btn_laser_20w_touch_platform_complete)
    Button mBtnComplete;
    @BindView(R.id.xyz_panel_touch_platform)
    XYZControlPanel mControlPanel;
    @BindView(R.id.iv_laser_20w_touch_platform)
    ImageView mIvPlatformHeight;

    private TouchPlatformViewModel mViewModel;

    public static Guide20wLaserTouchPlatformFragment newInstance() {
        return new Guide20wLaserTouchPlatformFragment();
    }
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_laser_20w_touch_platform;
    }
    ...
    @OnClick(R.id.btn_laser_20w_touch_platform_complete)
    void onCompleteClicked() {
        mViewModel.savePlatformZOffset();

        ((Guide20wLaserActivity) requireActivity()).startPullInFocusLeverFragment();
    }
}
