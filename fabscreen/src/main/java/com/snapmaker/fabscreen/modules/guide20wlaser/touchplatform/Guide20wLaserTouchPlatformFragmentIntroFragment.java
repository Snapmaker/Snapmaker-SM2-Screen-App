...
public class Guide20wLaserTouchPlatformFragmentIntroFragment extends BaseFragment {
    public static Guide20wLaserTouchPlatformFragmentIntroFragment newInstance() {
        return new Guide20wLaserTouchPlatformFragmentIntroFragment();
    }
        ...
        getModel().getPrintController().getHeaderSecurityStatus()
                ...
                .subscribe(headerSecurity -> {
                    if (headerSecurity.status == 0) {
                        ...
                        ((Guide20wLaserActivity) getActivity()).startPullOutFocusLeverFragment();
                    }
                });
    }
}
